...
export default function UserApplicationUpdate
  (props) {
    ...
    axios
      ...
      .then((res) => {
        if (res.data?.message === "Success") {
          ...
          //     message: `To track your application in TATA STEEL UISL Bulk Generation System your OTP is ${otp}. -Tata Steel UISL (JUSCO)`
  ...
  const otpVerified = () => {
    ...
    navigate("/applicationStatusEdit")
  };
    ...
    <>
      ...
      <Container maxWidth="xl" sx={styles.container}>
        <Paper sx={styles.paper} variant="outlined">
          ...
          <Typography sx={styles.loginText}>Track/Edit Application</Typography>
          <TextField
            id="username"
            type="text"
